...
export default function RebaseComponent({baseSystem, primaryGPU, developerEdition}: {
    baseSystem: string;
    primaryGPU: string;
    ...
    const imageNameBeta = getImageName(baseSystem, primaryGPU, developerEdition) + ":40"
    ...
    return (
        <section className={"flex flex-col gap-2"}>
            <div
                className={"bg-gradient-to-br from-aurora-darkblue to-aurora-purple text-white rounded-2xl p-2 cursor-pointer"}
                onClick={async () => {
                    toast({
            ...
            <p className={"text-xl font-bold text-aurora-lightred"}>Please do not rebase from another desktop environment. This is not
                supported and will cause issues!</p>
        </section>
    );
}