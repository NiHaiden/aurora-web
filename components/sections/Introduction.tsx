    ...
    <div ref={introRef}
      ...
      <div className={"flex flex-col items-center justify-center lg:m-0"}>
        <div className={"m-6 mt-20 p-4 flex flex-col justify-center items-center gap-5"}>
          ...
          <h1
            className={"text-5xl lg:text-6xl font-black text-center bg-aurora-blue drop-shadow-md text-transparent bg-clip-text leading-snug"}>Your
          ...
          <p className={"text-xl text-center"}>Aurora is the ultimate OS for every type of user, from normal
            ...
            <br />
            Run your spreadsheets or launch the next spacecraft. Your limit is the sky.</p>
        </div>

      </div>
      <div className={"flex flex-col items-center justify-center lg:m-0 mb-10"}>
        <button
          className={"mt-5 flex flex-row items-center gap-5 p-3 rounded-2xl justify-center bg-gradient-to-br from-aurora-blue to-aurora-purple animate-bounce"}
          onClick={() => {
