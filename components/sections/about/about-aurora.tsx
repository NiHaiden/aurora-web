...
export default function AboutAurora({aboutRef, aboutDxRef}: {aboutRef: RefObject<any>; aboutDxRef: RefObject<any>}) {
            ...
            <div className={"w-3/4 h-full flex flex-col gap-5 mb-32 mt-32"}>
                ...
                <section className={"grid grid-cols-1 grid-rows-4  lg:grid-cols-2 lg:grid-rows-1 gap-5 w-full"}>
                    ...
                    <div ref={ref2}
                        ...
                        <h1 className={"text-2xl text-center font-bold bg-gradient-to-br from-aurora-blue to-aurora-purple text-transparent bg-clip-text"}>Speed
                            and Reliability</h1>
                    ...
                    <div ref={ref3}
                        ...
                        <h1 className={"text-2xl font-bold bg-gradient-to-br from-aurora-blue to-aurora-purple text-transparent bg-clip-text"}>Zero
                            Maintenance</h1>
                    ...
                    <div ref={ref4}
                        ...
                        <h1 className={"text-2xl font-bold bg-gradient-to-br from-aurora-blue to-aurora-purple text-transparent bg-clip-text"}>Hardware
                            Support</h1>
