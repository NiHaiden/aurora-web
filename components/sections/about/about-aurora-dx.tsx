        ...
        <div className={"w-3/4 h-full flex flex-col gap-5 mt-32 mb-32"}>
          ...
          <div className={"grid grid-cols-1 grid-rows-4  lg:grid-cols-2 lg:grid-rows-1 gap-5 w-full mb-10"}>
            <div ref={ref1}
              ...
              <h1
                className={"text-2xl text-center font-bold bg-gradient-to-tr drop-shadow-md from-aurora-lightorange to-aurora-lightred text-transparent bg-clip-text"}>Brew,
                on tap.</h1>
            ...
            <div ref={ref3}
              ...
              <p className={"text-white text-xl"}>Visual Studio Code is preinstalled and already preconfigured to
                support devcontainer workflows. And with a single command, you can grab Jetbrains Toolbox if you like
                coffee more.</p>
            </div>
            <div ref={ref4}
