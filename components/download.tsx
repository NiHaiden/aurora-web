            ...
            <div className={"min-h-[75vh] w-full flex flex-col items-center justify-center gap-5"}>
                <div className={"w-3/4 h-3/4 flex flex-col gap-5 mt-5"}>
                    <div className={"flex flex-col items-left gap-4"}>
                        <h1 className={"text-7xl flex flex-row items-center gap-4 font-bold bg-gradient-to-br drop-shadow-md from-aurora-lightorange via-aurora-darkblue to-aurora-lightorange text-transparent bg-clip-text"}>
                            <Download className={"w-24 h-24 animate-fade-up stroke-aurora-darkblue"}/>Get Aurora
                        </h1>
                        <p className={"text-2xl text-black"}>🚀 Ready to ride the rocketship? Pick your hardware
                            configuration and download the ISO.</p>
                    </div>
                </div>
                <div className={"w-3/4 grid grid-rows-1 grid-cols-2"}>
                    ...
                    <div className={"flex flex-col justify-center items-center gap-2"}>
                        <h1 className={"text-3xl font-bold bg-gradient-to-tr from-aurora-lightorange via-aurora-darkblue to-aurora-purple text-transparent bg-clip-text"}>Get your ISO here:</h1>
